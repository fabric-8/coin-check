 ...
 */
export function extractToolsFromApi(api, prefix) {
    const tools = [];
    ...
    if (operation.requestBody) {
        ...
        if (jsonContent?.schema) {
            ...
            properties['requestBody'] = {
                type: 'string',
                description: opRequestBody.description ||
 ...
 */
export function mapOpenApiSchemaToJsonSchema(schema) {
    ...
    if (schema.oneOf || schema.anyOf || schema.allOf) {
        ...
        if (oneSchema) {
            ...
            for (let i = 1; i < oneSchema.length; i++) {
                ...
                if (typeof mappedSubSchema === 'object' &&
